...
public class ArquivoPessoaDAO {
    ...
    private final String caminho = "/home/jotausr/Projetos/UDESC/2023.2.POO/AulaPratica8/PessoasEmArquivos/src/files/pessoas.csv";
    ...
    private List<Pessoa> stringToListaPessoa(List<String> arquivo) {
        ...
        for (String linha : arquivo) {
            try {
                pessoas.add(fromCSV(tratarLinha(linha)));
            } catch (Exception e){
                continue;
            }
        }
