...
public class ArquivoContatoDAO {
    ...
    public List<Contato> lerContatos() throws ErroArquivoLeituraException {
    ...
    public void salvarContatos(List<Contato> contatos) throws ErroArquivoGravacaoException {
